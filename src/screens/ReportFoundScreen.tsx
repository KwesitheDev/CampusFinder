...
type ReportFoundScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'ReportFound'>;

const ReportFoundScreen: React.FC = () => {
    ...
    const navigation = useNavigation<ReportFoundScreenNavigationProp>();
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await reportItem(user.uid, 'found', category, description, location, photoUri);
